...
var Overlay = Widget.extend({
  ...
  // 进行定位
  _setPosition: function _setPosition(align) {
    // 不在文档流中，定位无效
  ...
  // 加载 iframe 遮罩层并与 overlay 保持同步
  _setupShim: function _setupShim() {
  ...
  _setupResize: function _setupResize() {
    Overlay.allOverlays.push(this);
  },

  // 除了 element 和 relativeElements，点击 body 后都会隐藏 element
  _blurHide: function _blurHide(arr) {
    arr = $.makeArray(arr);
  ...
  _onRenderZIndex: function _onRenderZIndex(val) {
    this.element.css('zIndex', val);
  },

  _onRenderAlign: function _onRenderAlign(val) {
    this._setPosition(val);
  },

  _onRenderVisible: function _onRenderVisible(val) {
